...
//       timeLabel.setText("");
    ...
    public GameGUI(ClientGame cg){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                while(!timeLabel.getText().startsWith("0")){
    ...
    public void showTimeout(){
        TimeOut to = new TimeOut(this, (int)getSize().getWidth(), (int)getSize().getHeight(), game.getScore());
        to.setVisible(true);
...
//	}
    ...
    protected gingermath_1.GradientPanel gradientPanel1;
